...
/* package haskell-platformer-game-0.1.0.0 */
#ifndef VERSION_haskell_platformer_game
#define VERSION_haskell_platformer_game "0.1.0.0"
#endif /* VERSION_haskell_platformer_game */
#ifndef MIN_VERSION_haskell_platformer_game
#define MIN_VERSION_haskell_platformer_game(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_platformer_game */
...
#define CURRENT_COMPONENT_ID "haskell-platformer-game-0.1.0.0-inplace-haskell-platformer-game"
